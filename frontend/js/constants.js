...
const welcome_p = 'Created by Degen Dads for Degen Dads.';
const h1_presale_coming_soon = "8BitsDADDY NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Public Minting Open!!";
const h2_presale_coming_soon = "Pre-Sale Minting Countdown";
const h2_presale_mint = "Public Minting Countdown";
const p_presale_coming_soon = "We are working hard to launch the NFT Collection. Us Dads are busy guys. NFTs, Kids, beer and wife all get in the wya. Stay tuned for updates!";
