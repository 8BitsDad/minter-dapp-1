...
const namePrefix = "EightBitDads";
const description = "Dads are DEGENS";
...
const PRESALE_WHITELISTED_ADDRESSES = ["0x9Fcc9FB84E1848E5E4a67cd9F18753687717a5c5"]; // only update if you want to manually set the whitelisted addresses
...
const GENERIC_DESCRIPTION = "Which Dad NFT will you get?"; // Replace with what you want the generic descriptions to say.
